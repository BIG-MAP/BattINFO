# Battery Descriptor Stable Subset

## Purpose

This document defines the stable BattINFO battery-descriptor subset that is ready for use in real systems.
...
- `src/battinfo/data/profiles/battery-descriptor/profile.json`
- generated profile fragments under `src/battinfo/data/profiles/battery-descriptor/generated/`
