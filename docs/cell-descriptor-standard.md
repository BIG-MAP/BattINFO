# Cell Descriptor Standard (Normative v1.0-draft)
...
- `src/battinfo/data/schemas/cell-descriptor.schema.json`
...
- see `cell-descriptor-stable-subset.md`
...
- `examples/cell-descriptors/extended.example.json`
