...
class AuthoringWorkspace:
    ...
    def _build_zenodo_jsonld(
        ...
        *,
        ...
        # ── Inline context: prefixes + EMMO properties + all prefLabel terms ────
        context: dict = {
            ...
            "battinfo:chemistry":   {"@id": "https://w3id.org/battinfo/chemistry"},
            "battinfo:cellFormat":  {"@id": "https://w3id.org/battinfo/cellFormat"},
            "spdx":             "http://spdx.org/rdf/terms#",
            "rdfs":             "http://www.w3.org/2000/01/rdf-schema#",
            "battery":          "https://w3id.org/emmo/domain/battery#",
            "electrochemistry": "https://w3id.org/emmo/domain/electrochemistry#",
            "emmo":             "https://w3id.org/emmo#",
            # EMMO object properties (from domain-battery.context.json)
            "hasProperty": {
            ...
            "hasTestObject": {
                "@id":   "https://w3id.org/emmo/domain/battery#battery_da3b3f28_aaad_4d67_b674_df47e109fb8b",
                "@type": "@id",
            },
            "hasTestEquipment": {
                "@id":   "https://w3id.org/emmo/domain/battery#battery_df4ff8f1_2cf2_444a_9498_23f533bd295c",
                "@type": "@id",
            },
            "hasOutput": {
        ...
        # Add prefLabel → compact IRI terms so the JSON body stays human-readable.
        # A JSON-LD processor expands e.g. "CylindricalBattery" → full IRI automatically.
